...
static void gen_db_path(char *buf, size_t len) {
    snprintf(buf, len, "/tmp/test_xmpp_users_%d_%d_%d.db",
...
static sqlite3 *open_test_db(const char *db_path) {
    ...
    sqlite3 *db = NULL;
    if (storage_db_open(&db) != 0) return NULL;
    return db;
}
...
int main(void) {
    const struct CMUnitTest tests[] = {
        /* Create tests. */
        cmocka_unit_test_setup_teardown(test_users_create_success,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_create_empty_password,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_create_long_jid,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_create_null_jid,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_create_null_password,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_create_duplicate,
                                        users_test_setup, users_test_teardown),

        /* Get tests. */
        cmocka_unit_test_setup_teardown(test_users_get_existing,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_get_nonexistent,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_get_null_output,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_get_null_jid,
                                        users_test_setup, users_test_teardown),

        /* Check password tests. */
        cmocka_unit_test_setup_teardown(test_users_check_password_correct,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_check_password_wrong,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_check_password_nonexistent,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_check_password_null_jid,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_check_password_null_password,
                                        users_test_setup, users_test_teardown),

        /* Disable tests. */
        cmocka_unit_test_setup_teardown(test_users_disable_success,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_disable_nonexistent,
                                        users_test_setup, users_test_teardown),
        cmocka_unit_test_setup_teardown(test_users_disable_null_jid,
                                        users_test_setup, users_test_teardown),

        /* Integration test. */
        cmocka_unit_test_setup_teardown(test_users_full_lifecycle,
                                        users_test_setup, users_test_teardown),
        ...
        cmocka_unit_test_setup_teardown(test_users_db_path_configured,
                                        users_test_setup, users_test_teardown),
    };
